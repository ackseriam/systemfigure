                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Editar corrección</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Editar corrección</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="card-body"> 
                                ...
                                <div class="col-lg-6">
                                     ...
                                     <div class="text-center w-75 m-auto">
                                        <h4 class="text-dark-50 text-center mt-0 font-weight-bold">Editar correccion a la guia </h4>
