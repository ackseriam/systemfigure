                                              ...
                                              <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="table dt-responsive nowrap">
                                                      <table  id="basic-datatable"  class="table table dt-responsive nowrap table-striped table-bordered table-centered mb-0"   width="100%">  onmousedown='return false;' onselectstart="return false;">
                                                          <thead>
                                                              <tr>
