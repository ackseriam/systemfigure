                            ...
                            <nav class="navbar navbar-dark navbar-expand-lg topnav-menu">
                                ...
                                <div class="collapse navbar-collapse" id="topnav-menu-content">
                                   <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle arrow-none animsition-link" href="">
                                 ...
                                 <section class=""  data-wow-iteration="infinite" data-wow-duration="1500ms"> 
                                  ...
                                  <div class="col-lg-6"> 
                                     <h3 class=" mt-3 widget">Juffyto Segovia - Owner, Ceo, Founder.</h3>
                                        <h5 class="punchline text-md-left" >“Hola ¿Qué tal? Yo soy Juffyto Segovia creador y fundador de la comunidad Figure Eight Task, te invito a ser parte de nuestra comunidad de trabajo, siempre estamos activos con nuevas opciones para generar ingresos extra por internet.” 
                                                      ...
                                                      <div class="row ">
                                                          ...
                                                          <div class="col-md-6">
                                                              <div class="text-md-right mt-3 pl-1  offset-lg-1">
                                                                      ...
                                                                      <img src="{{ asset('images/staff_figure/josue.png') }}" width="300" height="400" class=" rounded-circle"  alt="" >
                                                      ...
                                                      <div class="row ">
                                                          ...
                                                          <div class="col-md-6">
                                                              <div class="text-md-left mt-3 pl-1 ">
                                                                  ...
                                                                  <h5 class="text-md-left punchline " >”Buen día chicos soy Luigi administrador de la comunidad F8Task, estoy para lo <br>que necesiten no dudes en contactarme si tienes alguna duda de como ingresar con nosotros<br> y únete a la comunidad Figure Eight Task.”
                                                      ...
                                                      <div class="row ">
                                                         ...
                                                         <div class="col-md-6">
                                                                <div class="text-center mt-3 pl-1  offset-lg-1">
                                                                    ...
                                                                    <h3 class=" mt-3 text-md-right">Michael Castillo - Administrator, Co-founder, <br>Chief Customer Officer (CCO).</h3>
                                                      ...
                                                      <div class="row ">
                                                          ...
                                                          <div class="col-md-4">
                                                              <div class="text-md-center  mt-3 pl-1  offset-lg-1">
                                                                      ...
                                                                      <img src="{{ asset('images/staff_figure/abril.png') }}" height="400" width="250" class=" rounded-circle"  alt="" >
                                                          ...
                                                          <div class="col-md-4">
                                                              <div class="text-md-center mt-3 pl-1 ">
                                                                  ...
                                                                  <h5 class="text-md-center punchline " >“¡Hola, bienvenidos! Soy María La Cruz editora de esta comunidad. Te invito a formar parte de esta maravillosa familia, no te arrepentirás ;)”
                                                      ...
                                                      <div class="row ">
                                                          ...
                                                          <div class="col-md-4">
                                                              <div class="text-md-center mt-3 pl-1 ">
                                                                  ...
                                                                  <h5 class="text-md-center punchline " >“Hola, Mi Nombre Es Paul Ramirez, Realizo Trabajos (JOBS) De La Plataforma Figure Eight, Desde Hace Aproximadamente 3 Años,<br> Y Actualmente Soy Editor De Este Gran Grupo De Trabajo Y Gran Comunidad, F8 TASK ONLINE.”
                                                           ...
                                                           <div class="col-md-4">
                                                               <div class="text-md-center mt-3 pl-1 ">
                                                                  ...
                                                                  <h5 class="text-md-center  punchline " >Hola, soy Enmanuel, editor de la comunidad f8task, estoy aquí para ayudarte en lo que pueda ¡mucha suerte y trabaja duro!”
                                                          ...
                                                          <div class="col-md-6">
                                                           ...
                                                           <div class="col-md-6">
                                                               <div class="text-md-center mt-3 pl-1 ">
                                                                  ...
                                                                  <h5 class="text-md-center  punchline " >“Hola, espero estén bien. Yo soy Katiuska Millán, editora lvl0 de la comunidad Figure Eight. Una comunidad donde somos una familia, ayudando en cada uno de los trabajos, en la cual siempre estamos activos las 24h. Te invito a ser parte de esta comunidad, donde tienes una oportunidad de aprender junto con nosotros.”
