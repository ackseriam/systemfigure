...
{
    public $fillable = ['name','img','names_campo','number_campos','tiempo_envio','copiado','number_campos_img','names_campo_img','status','level','created_at']; //Todos los campos aqui
